...
int main(void)
{
    ...
    cout << "The cross section area of the cylinder is " << cross_area(r) << " c" << endl;
...
//The reason why it did not work the first time was because the variable r in the function side_area was not converted to inches, so I added
//that equation to the side_area function